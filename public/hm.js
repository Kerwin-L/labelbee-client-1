(function () {
  ...
  (function () {
    ...
    mt.f.R = function (d, e) {
      ...
      a.I(d) && 0 === String(d).indexOf("!HMCQ!")
        ? ((f = String(d)),
          (f = b.j("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], f.substring(6, f.length))))
        : a.I(d) ||
          ((f = mt.f.S(d)),
    ...
    try {
      window.localStorage
        ...
        : mt.localStorage.ka() &&
          ...
          mt.localStorage.l.load("labelbee-Client-0_2_0-alpha-1.sensebee.xyz"),
          mt.localStorage.l.setAttribute(a, b),
          mt.localStorage.l.save("labelbee-Client-0_2_0-alpha-1.sensebee.xyz"));
    } catch (f) {}
  };
      ...
      d = {
        ...
        Ya: function (a, b) {
          return (
            ...
            d.Za("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], a, b)
          );
        },
        Za: function (a, f, d) {
          if (a === s) return w;
  ...
  (function () {
    var a = mt.url,
      ...
      f = {
        ...
        ca: function () {
          for (
            var b = "labelbee-Client-0_2_0-alpha-1.sensebee.xyz", e = 0, f = c.dm.length;
            e < f;
            e++
          )
        ...
        pa: function () {
          for (var b = 0, e = c.dm.length; b < e; b++) {
            var f = c.dm[b];
            if (-1 < f.indexOf("/") && a.Xa("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0], f))
              return f.replace(/^[^/]+(\/.*)/, "$1") + "/";
          }
          return "/";
        },
      ...
      k = {
        ...
        _trackPageview: function (a) {
          1 < a.length &&
            ...
            k.ya || (h.c.b.su = h.c.b.u || "https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]),
            (h.c.b.u = g.protocol + "//" + "labelbee-Client-0_2_0-alpha-1.sensebee.xyz" + a[1]),
        ...
        _setReferrerOverride: function (a) {
          1 < a.length &&
            ...
            e.m(a, "String")
              ? ((h.c.b.su =
                  "/" === a.charAt(0)
                    ? g.protocol + "//" + "labelbee-Client-0_2_0-alpha-1.sensebee.xyz" + a
                    : a),
                (k.ya = u))
              : (k.ya = w));
        },
  ...
  (function () {
    ...
    c.spa !== s &&
      ...
      a.d("pv-b", function () {
        "" !== window.location.hash && (h.c.b.u = "https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
      }));
  })();
  (function () {
    function a() {
    ...
    a.prototype = {
      ...
      Qb: function () {
        ...
        var a = w;
        this.da(document.referrer) && this.da("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0])
          ? (a = u)
          : ((a = b.T(document.referrer)),
            (a = b.za(a || "", "labelbee-Client-0_2_0-alpha-1.sensebee.xyz")));
      ...
      rc: function () {
        ...
        if (
          0 === c.nv &&
          this.da("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]) &&
      ...
      dc: function () {
        var a = b.T("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
        return !f.H(
      ...
      sc: function () {
        ...
        this.b.vl = g.G();
        var a = "https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0];
        ...
        try {
          if (window.postMessage && window.self !== window.parent) {
            ...
            window.parent.postMessage(
              {
                id: c.id,
                url: "https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0],
      ...
      qb: function (a) {
        ...
        var e = this.b.u
          ? ""
          : "&u=" + encodeURIComponent("https://labelbee-Client-0_2_0-alpha-1.sensebee.xyz/" + window.location.href.split('/').slice(-1)[0]);
